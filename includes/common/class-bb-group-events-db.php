...
class BB_Group_Events_DB {
	...
	public function register_post_type() {
		$labels = array(
			'name'                  => _x( 'Group Events', 'Post Type General Name', 'bb-group-events' ),
			'singular_name'         => _x( 'Group Event', 'Post Type Singular Name', 'bb-group-events' ),
			'menu_name'             => __( 'Group Events', 'bb-group-events' ),
			'name_admin_bar'        => __( 'Group Event', 'bb-group-events' ),
			'archives'              => __( 'Group Event Archives', 'bb-group-events' ),
			'attributes'            => __( 'Group Event Attributes', 'bb-group-events' ),
